                    ...
                    <table class="grid" id="input-grid"> 
                        ...
                        <tr>
                            <td>
                                ...
                                <label><input type="checkbox" name="r" value="1" checked><span class="button-label">1</span></label>
                                <label><input type="checkbox" name="r" value="2" ><span class="button-label">2</span></label>
                                <label><input type="checkbox" name="r" value="3" ><span class="button-label">3</span></label>
                                <label><input type="checkbox" name="r" value="4" ><span class="button-label">4</span></label>
                                <label><input type="checkbox" name="r" value="5" ><span class="button-label">5</span></label>
                            </td>
                        </tr>
                        <tr>
                            <td id="line">     
